...
\usepackage[style=ieee,citestyle=numeric-comp,maxbibnames=10,sorting=none]{biblatex}% style=ext-numeric-comp,articlein=false,giveninits=true
...
\title{Smarter Stays, Smaller Footprint: Real-Time Resource Monitoring for Sustainable Airbnb Stays}
...
\Author{Daniel Montero Méndez}{School of Computing and Mathematical Sciences}
...
\Degree{Master of Science in Computer Science}{School of Computing and Mathematical Sciences}

% If there is more than one supervisor, use the \Supervisor command for each.
\Supervisor{Martyn Harris}{Programme Director}
...
\Institution{University of London, Birkbeck}
