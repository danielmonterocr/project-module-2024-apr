...
\Degree{Master of Science in Computer Science}{University of London}

% If there is more than one supervisor, use the \Supervisor command for each.
\Supervisor{Dr Martyn Harris}{Programme Director, School of Computing and Mathematical Sciences}
