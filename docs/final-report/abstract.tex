...
Airbnb\footnote{Airbnb's \href{http://www.airbnb.com}{website}} property. The data serves to provide guests with 
...
Application Programming Interface (API)\footnote{What is an \href{https://aws.amazon.com/what-is/api/}{API}?}  has been 
