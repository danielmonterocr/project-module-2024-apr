...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.7\textwidth]{swagger.png}
...
\begin{figure}[!ht]
    ...
    \centering{\includegraphics[alt={sample image},width=0.79\textwidth]{whatsapp-daily-report.jpg}}%
    \subcaption{\label{fig:whatsapp-daily-report}}
    \end{subfigure}
    %%%%%%%% don't leave a break here
    \begin{subfigure}[c]{0.495\textwidth}
    \centering{\includegraphics[alt={sample image},width=0.79\textwidth]{whatsapp-final-report.jpg}}%
    \subcaption{\label{fig:whatsapp-final-report}}%
    \end{subfigure}%
    \caption{Reports: (a) Daily report; (b) Final report.\label{fig:whatsapp-reports}}
\end{figure}
%%%%%%%%%%%%%%%%%%%  end figure  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
